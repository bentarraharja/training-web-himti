            ...
            <ul class="list-group">
                <?php foreach ($data['mhs'] as $mhs) : ?>
                    <li class="list-group-item mt-2"><?= $mhs['nama']; ?>
                        <a href="<?= BASEURL; ?>/mahasiswa/hapusData/<?= $mhs['id']; ?>" class="badge bg-danger float-end ms-1" onclick="return confirm('Data Akan dihapus?');">Hapus</a>
                        <a href="<?= BASEURL; ?>/mahasiswa/ubahData/<?= $mhs['id']; ?>" class="badge bg-primary float-end ms-1 tombolUbah" data-toggle="modal" data-target="#formModal" data-id="<?= $mhs['id']; ?>">Ubah</a>
                        <a href="<?= BASEURL; ?>/mahasiswa/detail/<?= $mhs['id']; ?>" class="badge bg-info float-end ms-1">Info</a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
